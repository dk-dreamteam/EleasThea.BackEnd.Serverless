...
{
    public static class CookingClassFunction
    {
        [FunctionName("CookingClassFunction")]
        public static async Task<IActionResult> Run(
            [HttpTrigger(AuthorizationLevel.Function, "post", Route = "CookingClass")] HttpRequest req,
